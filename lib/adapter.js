...
module.exports = (function () {
    ...
    var adapter = {
        ...
        registerCollection: function (collection, cb) {
            ...
            check_pool = def.config.pool
            if (def.config.pool) {
                //console.log("*******************************************");
                //console.log("Creating pooling connection");
                //console.log("db config: " + JSON.stringify(def.config));
